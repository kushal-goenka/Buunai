    ...
    <div id="content" class="<?php echo $class; ?> single-blog"><?php echo $content_top; ?>
	  ...
	  <div class="panel panel-default" style="margin-bottom: 10px;">
        <div class="row info">
          <div class="form-group">
            <label class="col-sm-3 control-label text-right"><b><?php echo $entry_author; ?></b></label>
            <div class="col-sm-3 author"><?php echo $blog_comment['author']; ?></div>
            <label class="col-sm-3 control-label text-right"><b><?php echo $text_date_added; ?></b></label>
            <div class="col-sm-3 date"><?php echo $blog_comment['date_added']; ?></div>
          </div>
        </div>
      ...
      <div class="panel panel-default" id="add-comment" style="margin-bottom: 10px; padding: 0px 10px;">
        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
          ...
          <div class="buttons text-right"><input class="btn btn-primary" type="submit" value="<?php echo $button_submit; ?>" data-toggle="tooltip" title="<?php echo $button_submit; ?>" /></div>
        </form>
        <?php } ?>
      </div>
