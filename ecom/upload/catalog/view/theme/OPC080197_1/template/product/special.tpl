        ...
        <div class="product-layout product-list col-xs-12">
		  ...
		  <div class="product-block-inner">
			...
			<div class="button-group">
              <button type="button" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="addtocart" onclick="cart.add('<?php echo $product['product_id']; ?>', '<?php echo $product['minimum']; ?>');"><i class="fa fa-shopping-cart"></i><?php //echo $button_cart; ?></button>
