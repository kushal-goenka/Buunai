...
<div class="container">
  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <h3 class="search-text"><?php echo $text_search; ?></h3>
      <?php if ($products) { ?>
        ...
        <div class="product-layout product-list col-xs-12">
		  ...
		  <div class="product-block-inner">
			...
			<div class="button-group">
              <button type="button" data-toggle="tooltip" title="<?php echo $button_cart; ?>" class="addtocart" onclick="cart.add('<?php echo $product['product_id']; ?>' , '<?php echo $product['minimum']; ?>');"><?php //echo $button_cart; ?><i class="fa fa-shopping-cart"></i></button>
